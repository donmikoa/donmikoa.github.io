...
//This project was originally written in Python. I had to convert is to JavaScript and MongoDB.
        ...
        .get('/update', (req, res) => {
            ...
            async function run() {
              try {
                ...
                // Execute a command to close the connection
                await client.close();
              }
            }
            run().catch(console.dir);
...
// Deleting a Document in the Animal Database
polka()
    .get('/delete', (req, res) => {
        const client = new MongoClient("mongodb://localhost:27017");
        async function run() {
